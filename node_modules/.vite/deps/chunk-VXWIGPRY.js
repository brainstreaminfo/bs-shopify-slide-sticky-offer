...
var SHOPIFY_API_LIBRARY_VERSION = "11.6.1";
...
var DEFAULT_CLIENT_VERSION = "1.2.1";
...
var DEFAULT_CLIENT_VERSION2 = "1.0.4";
...
var DEFAULT_CLIENT_VERSION3 = "1.0.3";
...
function updateUsageCappedAmount(config) {
  return async function updateUsageCappedAmount2(params) {
    ...
    try {
      ...
      return {
        confirmationUrl: (_f = (_e = response.data) == null ? void 0 : _e.appSubscriptionLineItemUpdate) == null ? void 0 : _f.confirmationUrl,
        appSubscription: (_h = (_g = response.data) == null ? void 0 : _g.appSubscriptionLineItemUpdate) == null ? void 0 : _h.appSubscription
      };
    } catch (error) {
      if (error instanceof GraphqlQueryError) {
        throw new BillingError({
...
//# sourceMappingURL=chunk-VXWIGPRY.js.map
